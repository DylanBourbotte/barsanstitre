...
<div class="col-12 text-center rare"><cite>"La rareté fait l'exclusivitée"</cite></div>
</div>
</section>
...
<div class="container">
    <div class="row">
        <div class="col-12 text-center titlebar">Un rooftop unique.</div>
        <div class="col-12 text-center">
            <?php echo get_text('text-accueil2', $textes); ?>
        </div>
